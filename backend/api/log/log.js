 ...
 * @Last Modified time: 2018-11-17 15:03:00
 */
class log {
    async operationLog(ctx) {
        ...
        let operationDescription = new Map([
            ...
            ['/api/user/changePassword', [status === 200 ? `${operator}修改了密码` : `未知用户尝试修改${record.user.username}的密码未遂`]]
        ])
        console.log(operationDescription.get(url));
